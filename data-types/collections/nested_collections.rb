...
class NestesdCollectionsTest < Minitest::Test
  ...
  def test_10
    ...
    kenny_is_pitcher = !team[:pitchers]{"Kenny"}.nil?
  ...
  def test_15
    ...
    actual = three_day_forecast[:days] = 55
    expected = 55
    assert_equal expected, actual
  end
  ...
  def test_16
    ...
    actual = three_day_forecast[:days] = [:high, :low, :summary]
