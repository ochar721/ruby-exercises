...
class ArraysTest < Minitest::Test
  ...
  def test_4
    ...
    assert_equal "Brazil", world_cup[4]= "Brazil"

    # Use a different method to add the element "Japan" to the end of the array

    assert_equal "Japan", world_cup = ("Japan")
end
  ...
  def test_a
    ...
    assert_equal "Portugal", last_element.delete("Portugal")
